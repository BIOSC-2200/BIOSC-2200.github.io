...
There appears to be a big change in the allele frequency in Line 6, so let's begin with that line. Line 6 is one of the ones that is selected for increased wheel activity. Although the mini-muscle allele was not directly selected for, it appears that the frequency increases across generations.
