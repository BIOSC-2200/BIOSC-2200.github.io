...
2. $\Sigma$ is the shorthand for a summation, adding a set of numbers together
...
![Total wheel revolutions per day for 4 selected and 4 control lines of mice across the first 10 generations of selection. From Swallow et al. [-@Swallow1998-xo]](../images/garland1.png){width=50% fig-align="center" fig-alt="" #fig-run}
...
![Proportion of mice exhibiting the small muscle phenotype in three lines. The squares in this plot (Line 3) are the same line as the blue points in the plot above. From Garland et al. [-@Garland2002-it]](../images/garland2.png){width=50% fig-align="center" fig-alt="" #fig-mmgen}
...
![Observed muscle masses  compared to body mass in a sample of 404 F~2~ backcross mice. From Hannon et al. [-@hannon_phenotypic_2008a]](../images/garland3.png){width=50% fig-align="center" fig-alt="" #fig-f2}
